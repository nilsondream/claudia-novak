...
const Hero = () => {
    ...
    return (
        <div className="overflow-hidden pl-10 fixed left-0 top-0 z-[-1] h-[75vh] flex items-center">
            <h1 ref={slider} className="font-custom text-[25vw] whitespace-nowrap flex">
